...
import com.savdev.mvn.mm.template.project.commons.jax.rs.client.JaxRsProxyConfig;
...
public class AuthClientRequestFilterFactory {
    ...
    try {
      ...
      return jwt2factorCachedAuthentication(
        ...
        JaxRsProxyConfig.builder()
          .withDomain(basicAuthDomain)
          .withBasicAuth(login, password)
          .withClazz4Logging(clazz4Logging)
          .build(),
        authInterface,
