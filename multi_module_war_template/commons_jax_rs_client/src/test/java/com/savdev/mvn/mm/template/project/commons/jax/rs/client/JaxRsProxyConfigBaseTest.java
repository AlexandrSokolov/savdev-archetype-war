...
public class JaxRsProxyConfigBaseTest {
  ...
  public static void setUpServer(
    final Collection<Class<?>> types) throws Exception {
  ...
  public static void setUpServer(
    ...
    System.setProperty("org.apache.commons.logging.simplelog.log."
      + JaxRsProxyConfigBaseTest.class.getPackage().getName(), "DEBUG");
